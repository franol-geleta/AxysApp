...
import { Header, PinInput } from '../../components/common';
import { PinLockIcon } from '../../components/icons';
import { useAuth } from '../../context/AuthContext';

type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'ResumePinCode'>;

interface Props {
  navigation: NavigationProp;
}

export const ResumePinCodeScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleVerify = async () => {
    ...
    if (isValid) {
      if (!hasBiometricsSetup) {
        navigation.replace('ResumeBiometrics');
      } else {
  ...
  const handleForgotPin = () => {
    // Navigate to forgot PIN flow or show alert
